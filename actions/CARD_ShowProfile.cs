...
public class XpService
{
    public XpProgress GetProgress(UserProfile user)
    {
        ...
        return new XpProgress { XpIntoLevel = user.Xp - xpAtStart, XpForNext = xpForNext };
    }
    ...
    private int XpForLevel(int level) => (int)(100 * Math.Pow(level, 1.5));
}
...
public class CPHInline
{
    public bool Execute()
    {
        ...
        // 5. Rang live — filtrer les exclus du calcul de rang
        ...
        var progress = new XpService().GetProgress(user);

...
public class XpService
{
    ...
    // Prépare le leaderboard trié par XP décroissant
    // Appelé avec tous les profils chargés par UserRepository.GetAllUsers()
    // Scalable : export web, overlay leaderboard, profile cards rank

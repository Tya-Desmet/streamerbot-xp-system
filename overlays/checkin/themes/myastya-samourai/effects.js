/* ============================================================
   CheckIn — Effets MYASTYA-SAMOURAI
...
(function () {
  ...
  // PER-OVERLAY : fleur perchée sur le coin haut-gauche de la fenêtre check-in
  var FLOWERS = [
    { parent: '#checkin-container', style: { position: 'absolute', left: '-18px', top: '-22px', width: '54px', height: '54px', zIndex: '5' } }
  ];
  ...
  /* ========================================================
     4) HOOKS — branchés sur les animations check-in existantes
     ======================================================== */
  function onAnim(e) {
    switch (e.animationName) {
      case 'ci-stamp':    SFX.play('appear'); break;
      case 'ci-box-fill': SFX.play('petal', { volume: 0.9 }); burstAtEl(e.target, 7, 'center'); break;
      case 'ci-pulse':    SFX.play('complete'); burstAtEl(document.getElementById('checkin-container'), 30, 'center'); break;
    }
  }
